              ...
              <div class="large-7 columns info">
                  <div class="row title">
                      ...
                      <div class="small-4 columns">
                          <h2>IBM<sup>&reg;</sup> SPSS<sup>&reg;</sup> Amos 24</h2>
                      </div> 
                  ...
                  <div class="row ctaBtns">
                      <a href="https://estore.onthehub.com/WebStore/OfferingDetails.aspx?o=ef357a31-afeb-e511-9417-b8ca3a5db7a1&utm_source=LandingPage-SPSS-Amos-&utm_medium=LandingPage-b&utm_campaign=SPSS" target="_blank" onclick="tob(this, '<?php echo $gaEvent; ?>', '<?php echo $gaEvent; ?> - Clickthrough', '<?php echo $gaEvent; ?> v2 - Clickthrough - Amos - Buy'); return false;">
