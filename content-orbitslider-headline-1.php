  <div id="<?php echo $blocks[$counter]; ?>" class="row mainContent content-challenges headline-circles-orbitslider" data-block="<?php echo $blocks[$counter]; ?>">
      <div class="container">
          <div class="row">
              <div class="large-12 columns info center">
                    <h1>We eliminate the barriers of O365 deployments</h1>
                    <p>Under a standard deployment of Student Advantage, the integration requirements with the Microsoft O365 environment and ongoing program management often demands large investments of time and resources that many schools do not want to undertake.</p>
              </div> 
          </div> 
          <div class="row circles show-for-medium-up">
              <ul class="small-block-grid-2 medium-block-grid-2 large-block-grid-4 center">
                  ...
                  <li>
                      ...
                      <p>Adding and maintaining users in the O365 environment requires the time and effort of either Active Directory integration or uploading user accounts.</p>
                  </li>
                  <li>
                      <img src="img/challenges-license-mngmnt.png">
                      <h3>Endless license management</h3>
                      <p>With standard deployment, you are responsible for tedious licence distribution, managing license turnover, and monitoring for accurate usage.</p>
                  </li>
                  <li>
          ...
          <div class="row show-for-small">
              <ul class="example-orbit-content" data-orbit data-options="animation:slide;pause_on_hover:true;timer_speed:100000;navigation_arrows:false;">
                  ...
                  <li data-orbit-slide="headline-3">
                    <div>
                      <img class="inline-block" src="img/challenges-license-mngmnt.png">
                      <h3>Endless license management</h3>
                      <p>With standard deployment, you are responsible for tedious licence distribution, managing license turnover, and monitoring for accurate usage.</p>
                    </div>
                  </li>
